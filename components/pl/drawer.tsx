...
import { Button } from "@/components/pl/button"
import { ScrollArea } from "@/components/pl/scroll-area"
  ...
  return (
    <DrawerPrimitive.Viewport
      ...
      className={cn(
        ...
        // length unit: Tailwind â‰¥4.3.1 compiles `--spacing(0)` to a unitless
        ...
        // just be a normal flex item pinned to an edge â€” a grid "auto" row
        ...
        // of writing direction â€” but they aren't part of Tailwind's
          ...
          <DrawerPrimitive.Popup
            ...
            className={cn(
              ...
              variant === "inset" &&
                ...
                // rounded, bordered card instead â€” nothing sits behind it to
              ...
              (position === "bottom" || position === "top") &&
                ...
                // with tall content. Cap it against the viewport directly â€”
  ...
  const defaultProps = {
    className: cn(
      ...
      variant === "default" &&
        ...
        // (bg-popover), which doesn't match the footer's muted background â€”
        ...
        // *generated content of the popup itself* â€” which has a transform
        // and so establishes its own stacking context â€” it paints as if it
      ...
      // (e.g. pr-2 for a left drawer), which insets every child equally â€”
...
function DrawerPanel({
  ...
  if (scrollable) {
    // ScrollArea's own root has no intrinsic height â€” as a flex item inside
