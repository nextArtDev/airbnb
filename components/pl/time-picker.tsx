...
import {
  ...
  DrawerTitle,
  DrawerTrigger,
} from "@/components/pl/drawer"
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/components/pl/popover"
import type { WheelPickerOption } from "@/components/pl/wheel-picker"
import { WheelPicker, WheelPickerWrapper } from "@/components/pl/wheel-picker"
...
/** Formats a `TimePickerValue` for display, e.g. "09:30" or "09:30 Ø¨.Ø¸". */
...
function ResponsiveTimePickerContent({
  ...
  side = "bottom",
  sideOffset = 6,
  drawerTitle = "Ø§Ù†ØªØ®Ø§Ø¨ Ø²Ù…Ø§Ù†",
  drawerConfirmLabel,
  onDrawerConfirm,
  className,
  ...timePickerProps
