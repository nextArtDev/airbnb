    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            'flex min-h-[52px] w-full items-center gap-2 rounded-xl   bg-card px-3 py-2 text-start transition hover:border-foreground/40',
        ...
        >
          {/* <CalendarIcon
            ...
            aria-hidden
          /> */}
          <span className="min-w-0 flex-1  flex flex-col   gap-4">
