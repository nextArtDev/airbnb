...
function parseFilters(sp: Record<string, string | string[] | undefined>): HomeFilters {
  const one = (k: string) => {
    const v = sp[k];
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-4 pt-4">
          <div className="scrollbar-none flex gap-6 overflow-x-auto pb-2" dir="ltr">
        ...
        <section className="mx-auto max-w-6xl px-4 py-8">
          <h2 className="mb-5 text-lg font-semibold">
            {filters.city ? t("resultsFor", { query: filters.city }) : t("allListings")}
          </h2>
          <Suspense
            fallback={
              <div className="grid grid-cols-1 gap-x-6 gap-y-9 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
